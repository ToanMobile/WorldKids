...
import com.app.presentation.extensions.showUrlInBrowser
import com.app.presentation.scenes.carddetail.CardDetailScreen
import com.app.presentation.scenes.home.CardListScreen
...
sealed class NavScreen(val route: String) {
    ...
    object CardDetail : NavScreen("CardDetail/{name}") {
        ...
        fun createRoute(cardName: String): String = route.replace("{$argName}", cardName)
    }
}
